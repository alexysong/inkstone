...
reflection_1layer_1d_grad0 = jax_grad(reflection_1layer_1d,0)
reflection_1layer_1d_grad1 = jax_grad(reflection_1layer_1d,1)
reflection_1layer_1d_grad2 = jax_grad(reflection_1layer_1d,2)
reflection_1layer_1d_grad3 = jax_grad(reflection_1layer_1d,3)

def test_reflection_1layer_1d_grad0(params_1layer_1d):
    """
    ...
    for d in grating_thicknesses:
        ...
        AD_grad = reflection_1layer_1d_grad0(d,*params,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)
    
def test_reflection_1layer_1d_grad1(params_1layer_1d):
    """
    ...
    for w in grating_widths:
        ...
        AD_grad = reflection_1layer_1d_grad1(d,w,*params,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)

def test_reflection_1layer_1d_grad2(params_1layer_1d):
    """
    ...
    for f in frequencies:
        ...
        AD_grad = reflection_1layer_1d_grad2(d,w,f,p,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)

def test_reflection_1layer_1d_grad3(params_1layer_1d):
    """
    ...
    for p in permittivities:
        ...
        AD_grad = reflection_1layer_1d_grad3(*params,p,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)


# abs_Ey_1layer_1d #
abs_Ey_1layer_1d_grad0 = jax_grad(abs_Ey_1layer_1d,0)
abs_Ey_1layer_1d_grad1 = jax_grad(abs_Ey_1layer_1d,1)
abs_Ey_1layer_1d_grad2 = jax_grad(abs_Ey_1layer_1d,2)
abs_Ey_1layer_1d_grad3 = jax_grad(abs_Ey_1layer_1d,3)
abs_Ey_1layer_1d_grad4 = jax_grad(abs_Ey_1layer_1d,4)

def test_abs_Ey_1layer_1d_grad0(params_1layer_1d):
    """
    ...
    for d in grating_thicknesses:
        ...
        AD_grad = abs_Ey_1layer_1d_grad0(d,*params,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)
    
def test_abs_Ey_1layer_1d_grad1(params_1layer_1d):
    """
    ...
    for w in grating_widths:
        ...
        AD_grad = abs_Ey_1layer_1d_grad1(d,w,*params,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)

def test_abs_Ey_1layer_1d_grad2(params_1layer_1d):
    """
    ...
    for f in frequencies:
        ...
        AD_grad = abs_Ey_1layer_1d_grad2(d,w,f,p,z,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)

def test_abs_Ey_1layer_1d_grad3(params_1layer_1d):
    """
    ...
    for p in permittivities:
        ...
        AD_grad = abs_Ey_1layer_1d_grad3(*params,p,z,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)

def test_abs_Ey_1layer_1d_grad4(params_1layer_1d):
    """
    ...
    for z in z_positions:
        ...
        AD_grad = abs_Ey_1layer_1d_grad4(*params,z,num_g=30,backend="jax")
        assert np.allclose(AD_grad, FD_grad, rtol=rel_tol, atol=abs_tol)
