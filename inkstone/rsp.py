...
def rsp(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22,gb=gb):
    ...
    t1 = idt - sb11 @ sa22
    t2 = idt - sa22 @ sb11
    p1 = gb.sla.solve(t1.T, sa12.T).T
    p2 = gb.sla.solve(t2.T, sb21.T).T
...
def rsp_sa21Tlu(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22):
    ...
    s11 = sa11 + p1 @ gb.sla.lu_solve(sa21, sb11.T).T
    s12 = p1 @ sb12
    s21 = gb.sla.lu_solve(sa21, p2.T).T
    s22 = sb22 + p2 @ sa22 @ sb12
...
def rsp_sa12lu(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22):
    ...
    s11 = sa11 + gb.sla.lu_solve(sa12, (gb.sla.solve(t1, sb11) @ sa21))
    s12 = gb.sla.lu_solve(sa12, (gb.sla.solve(t1, sb12)))
    s21 = p2 @ sa21
    s22 = sb22 + p2 @ sa22 @ sb12
...
def rsp_sb12Tlu(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22):
    ...
    s11 = sa11 + p1 @ sb11 @ sa21
    s12 = gb.sla.lu_solve(sb12, p1.T).T
    s21 = p2 @ sa21
    s22 = sb22 + p2 @ gb.sla.lu_solve(sb12, sa22.T).T
...
def rsp_sb21lu(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22):
    ...
    s11 = sa11 + p1 @ sb11 @ sa21
    s12 = p1 @ sb12
    s21 = gb.sla.lu_solve(sb21, gb.sla.solve(t2, sa21))
    s22 = sb22 + gb.sla.lu_solve(sb21, gb.sla.solve(t2, sa22) @ sb12)
...
def rsp_sa21Tlu_sb21lu(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22):
    ...
    s11 = sa11 + sa12 @ gb.sla.lu_solve(sa21, gb.sla.solve(t1, sb11).T).T
    s12 = sa12 @ gb.sla.solve(t1, sb12)
    s21 = gb.sla.lu_solve(sb21, gb.sla.solve(t2, gb.sla.lu_solve(sa21, idt).T))
    s22 = sb22 + gb.sla.lu_solve(sb21, gb.sla.solve(t2, sa22) @ sb12)
...
def rsp_sa12lu_sb12Tlu(sa11, sa12, sa21, sa22, sb11, sb12, sb21, sb22):
    ...
    s11 = sa11 + gb.sla.lu_solve(sa12, gb.sla.solve(t1, sb11)) @ sa21
    s12 = gb.sla.lu_solve(sa12, gb.sla.solve(t1, gb.sla.lu_solve(sb12, idt).T))
    s21 = sb21 @ gb.sla.solve(t2, sa21)
    s22 = sb22 + sb21 @ gb.sla.lu_solve(sb12, gb.sla.solve(t2, sa22).T).T
